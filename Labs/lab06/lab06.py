class Transaction:
    ...
    def report(self):
        ...
        if self.changed():
            ...
            msg = ('increased ' if delta > 0 else 'decreased ')+ str(self.before) + '->' + str(self.after) 
...
class Coin:
    ...
    def worth(self):
        delta = Mint.present_year - self.year - 50 if Mint.present_year - self.year > 50 else 0
        return self.cents + delta
